...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME = "MuseumDB";// Database name
    public File dbfile;
    ...
    public SQLiteDatabase createDataBase(Context blah) throws Exception{ //overloaded test version
        boolean mDataBaseExist = checkDataBase();
        if(!mDataBaseExist)
        {
            this.getReadableDatabase();
    ...
    private void copyDataBase() throws Exception
    {
        ...
        try {
            ...
            mOutput.close();
            mInput.close();
            System.out.println("copyDataBase successful");
        }catch(Exception E){
