...
public interface IChoiceDialogCompliant {
	...
	public void doYesConfirmClick(final int from, int selected);
	public void doNoConfirmClick(final int from, int selected);
}
